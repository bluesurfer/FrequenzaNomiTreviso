...
(function() {
  ...
  define(function() {
    ...
    return {
      english_exponent_for_number: function(n) {
        n = n.toString();
        if (n.match(/1$/) && !n.match(/11$/)) {
          return "st";
        } else if (n.match(/2$/) && !n.match(/12$/)) {
          return "nd";
        } else if (n.match(/3$/) && !n.match(/13$/)) {
          return "rd";
        } else {
          return "th";
        }
      },
      format_date: function(date, format, lang) {
        var day, m, months, s, y;
        if (format == null) {
          format = "long";
        }
        if (lang == null) {
      ...
      random_color: function() {
        ...
        nums = (function() {
          ...
          for (n = _i = 1; _i <= 3; n = ++_i) {
            n = parseInt(Math.random() * 256).toString(16);
            if (n.length === 1) {
              n = "0" + n;
            }
            _results.push(n);
      ...
      constrain: function() {
        var max_val, min_val, val, vals, _ref;
        val = arguments[0], vals = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
        _ref = vals.sort(), min_val = _ref[0], max_val = _ref[1];
      ...
      random: function(from, to) {
        ...
        return Math.random() * Math.abs(from) + Math.abs(to) + from;
      },
      ...
      remove_accents: function(str) {
        ...
        */
        ...
        for (letter in alphabet) {
          regx = alphabet[letter];
          str = str.replace(regx, letter);
        }
        return str;
      },
      uniq: function(arr, accessor) {
        var el, key, output, value, _i, _len, _results;
        if (accessor == null) {
          accessor = null;
        }
